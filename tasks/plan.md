...
- [ ] Run workspace tests, typecheck, build, lint
- [ ] Review changed files across correctness, architecture, accessibility, and performance
- [ ] Update Linear, wiki, PR, CI, and local main
...
- [ ] 좁은 화면·긴 상품명·null 가격·접근성 런타임 검증
