...
const PUSH_CANDIDATE_COLUMNS =
  "id, push_token, push_enabled, deadline_reminders_enabled, new_submissions_enabled, submission_approval_notifications_enabled, marketing_push_enabled, followed_influencers, followed_brands";
