-- Align ranking eligibility with active APPROVED deals while preserving
-- the latest v2 scoring, cursor, and username fallback semantics verbatim.
-- v3 stays additive so the Edge Function and migration can deploy in either order.

CREATE OR REPLACE FUNCTION public.get_group_buy_rankings_v3(
