...
export const publicGroupBuySchema = z.object({
  ...
  postAudioUrl: z.string().url().nullable().optional().default(null),
  postAudioStartTimeMs: z.number().int().nonnegative().nullable().optional().default(null),
  postAudioDurationMs: z.number().int().positive().nullable().optional().default(null),
